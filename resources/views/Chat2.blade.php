	...
	<div class="contact">
		...
		<div class="form">
			...
			<form action="">
				...
				<div class="flex-rev">
					<textarea placeholder="Massage" name="message" id="message" /></textarea>
					<label for="message">Email Message</label>
				</div>
				<a href="mailto::fawazgrs85@gmail.com"><button>Send Email</button></a>
			</form>
		</div>
	</div>
</div>