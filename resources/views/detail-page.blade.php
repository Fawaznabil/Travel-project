...
<head>
	...
	<!-- Favicons-->
	<link rel="shortcut icon" href="img/favicon.ico" type="aset/x-icon">
	<link rel="apple-touch-icon" type="image/x-icon" href="img/apple-touch-icon-57x57-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="aset/apple-touch-icon-72x72-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="aset/apple-touch-icon-114x114-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="aset/apple-touch-icon-144x144-precomposed.png">
	...
	<!-- SPECIFIC CSS -->
	<link href="date_time_picker.css" rel="stylesheet">
...
<body>
	...
	<div id="full-slider-wrapper">
		<img src="aset/cover.jpg" class="ls-bg" >
	</div>
	<!-- End section -->
	<!-- End SubHeader ============================================ -->
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="owl-carousel add_bottom_15">
						<div class="item"><img src="aset/2.jpg" alt="">
						</div>
						<div class="item"><img src="aset/2.jpg" alt="">
						</div>
						<div class="item"><img src="aset/2.jpg" alt="">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a  data-toggle="tab" href="#tab_1">Overview</a>
						</li>
						<li><a data-toggle="tab" href="/Riviews">Reviews</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						<div id="tab_1" class="tab-pane fade in active" >
								...
								<div class="col-md-6">
									<div class="feature-box">
										<div class="feature-box-icon">
											<svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-check2-circle" viewBox="0	 0 16 16">
							...
							<h3>Informasi Pemesanan <span>(4 days)</span></h3>
							<p>
				...
				<aside class="col-md-4">
					<div class="box_style_1">
						<div class="price">
							<strong>Rp 250.000</strong><small>per person</small>
						</div>
						<ul class="bi bi-check2">
						...
						<small>*Free mineral water</small>
					</div>
							...
							<table id="tickets" class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><span class="subtotal">Rp 0</span>
										</td>
									</tr>
	
									<tr>
										<td><strong>Student</strong> <span class="price">Rp 250.000</span> </td>
										<td>
											<div class="styled-select">
	...
	<script src="sidebar_carousel_detail_page_func.js"></script>
