			...
			<div class="row">
				<div class="col-md-8">
					...
					<ul class="nav nav-tabs">
						<li><a  data-toggle="tab" href="#tab_1">Overview</a>
						</li>
						<li class="active"><a data-toggle="tab" href="#tab_2">Reviews</a>
						</li>
					</ul>
						...
						<div id="tab_2" class="tab-pane fade in active" >
							<div id="summary_review">
								...
								<div class="review_score_2">
									<h4>SalwaTravel <span>(Based on 20 reviews)</span></h4>
									<p>
							...
							<div class="reviews-container">
								<div class="review-box clearfix">
									<figure class="rev-thumb"><img src="aset/face4.jpg" alt="">
									</figure>
								...
								<div class="review-box clearfix">
									<figure class="rev-thumb"><img src="aset/face2.jpg" alt="">
									</figure>
									<div class="rev-content">
										<div class="rating">
											<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
								...
								<div class="review-box clearfix">
									<figure class="rev-thumb"><img src="aset/face5.jpg" alt="">
									</figure>
									<div class="rev-content">
										<div class="rating">
											<i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="ibi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
										</div>
										<div class="rev-info">
											Sara – March 31, 2016:
										</div>
