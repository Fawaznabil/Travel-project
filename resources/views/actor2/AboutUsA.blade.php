...
<!-- End Header 1-->
	...
	<div id="full-slider-wrapper">		
		<img src="aset/cover2.jpg" class="ls-bg">		
	</div>
	<!-- End section -->
	<!-- End SubHeader ============================================ -->
	...
	<section class="wrapper">
		...
		<div class="container">
			<div class="main_title">
				<h2>Some <span>Salwa Travel</span> info</h2>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<p class="advertise"><img src="aset/salwatravel.png" alt="" class="img-responsive">
					</p>
				</div>
			</div>
			<!-- End row -->
			...
			<div class="owl-carousel team-carousel add_bottom_30">
				...
				<div class="team-item">
					<div class="team-item-img">
						<img src="aset/ceo13-removebg-preview.png" alt="">
						<div class="team-item-detail">
							<div class="team-item-detail-inner">
								<h4>Ronald Green</h4>
								<p>Similique sunt culpa qui officia deserunt mollitia animi dolorum fuga.</p>
