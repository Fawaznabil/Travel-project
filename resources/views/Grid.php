...
<body>
	...
	<script src="query.tweet.min.js"></script>
...
<<<<<<< HEAD
	...
	<div class="hero overlay">
		<div class="img-bg rellax">
			<img src="aset/hero_2.jpg" alt="Image" class="img-fluid">
		</div>
		<div class="container">
				...
				<div class="col-md-8 blog-content pe-5">
					...
					<div class="pt-5">
						...
						<ul class="comment-list">
							<li class="comment">
								<div class="vcard bio">
									<img src="aset/person_2.jpg" alt="Free Website Template by Free-Template.co">
								</div>
							...
							<li class="comment">
								<div class="vcard bio">
									<img src="aset/person_3.jpg" alt="Free Website Template by Free-Template.co">
								</div>
								<div class="comment-body">
									<h3>Chris Meyer</h3>
									<div class="meta">January 9, 2018 at 2:21pm</div>
								...
								<ul class="children">
									<li class="comment">
										<div class="vcard bio">
											<img src="aset/person_1.jpg" alt="Free Website Template by Free-Template.co">
										</div>
										<div class="comment-body">
											<h3>Chintan Patel</h3>
											<div class="meta">January 9, 2018 at 2:21pm</div>
...
<!--						<div class="comment-form-wrap pt-5">
				...
				<div class="col-md-4 sidebar">
					...
					<div class="sidebar-box">
						<img src="aset/person_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid mb-4 w-50 rounded-circle">
